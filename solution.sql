...
SELECT syntax_practice WHERE "username" ILIKE '%a%';
...
--8. Add a new record. calues: username, city, transactions_completed, transactions_attempted, account_balance
INSERT INTO syntax_practice(username, city, transactions_completed, transactions_attempted, account_balance)
VALUES('mickey', 'miami', 5, 10, 666); 
